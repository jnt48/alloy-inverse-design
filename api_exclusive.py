...
app = FastAPI(title="Task 3 - Part 3 (EXCLUDING 2x and 7x Series)")
...
# ======================================================================================
# 1. DATA PREPARATION & FEATURE ENGINEERING (EXCLUDING 2x/7x SERIES)
# ======================================================================================
def load_and_prep_data(file_path):
    print(f"[{'='*20} 1. DATA LOADING & PREPARATION (EXCLUDING 2x/7x) {'='*20}]")
    try:
...
@app.get("/")
def read_root():
    return {"message": "API Exclusive is running. Go to /docs for Swagger UI."}
